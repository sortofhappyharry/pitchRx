...
abpitch$final_pitch<-with(abpitch,ifelse(lead(batter_name)!=batter_name,1,0)) # did PA terminate on this pitch
abpitch$pitch_value<-with(abpitch,ifelse(
  final_pitch==1,
  play_matrix2[event,1]-count_value2[count,1]+count_value2["0-0",1],
